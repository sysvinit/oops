...
public class UserNotOnChannel extends DBusExecutionException {
    public UserNotOnChannel(String user, String chan) {
	super(String.format("User '%s' is not on channel '%s'", user, chan));
    }
}
