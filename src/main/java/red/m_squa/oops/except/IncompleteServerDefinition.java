...
public class IncompleteServerDefinition extends ServerLoadError {
    public IncompleteServerDefinition(String msg) {
	super(String.format("Incomplete server definition: %s", msg));
    }
}
