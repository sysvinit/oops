...
public class ServerNotLoaded extends DBusExecutionException {
    public ServerNotLoaded(String name) {
	super(String.format("No server definition with name '%s' is currently "
                        + "loaded", name));
    }
}
