...
public class MalformedServerDefinition extends ServerLoadError {
    public MalformedServerDefinition(String name) {
	super(String.format("Definition for server '%s' is malformed", name));
    }
}
