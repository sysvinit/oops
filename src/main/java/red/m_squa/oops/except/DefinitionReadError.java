...
public class DefinitionReadError extends ServerLoadError {
    public DefinitionReadError(String name) {
	super(String.format("Error when reading server definition '%s'", name));
    }
}
